...
export class CandidatsComponent implements OnInit {
  ...
  generateLink(candidat: Candidate): string {
    ...
    // Inclure le domaine dans le chemin de la route et passer candidatId en paramètre query
    return `${baseUrl}/entretien/${encodeURIComponent(this.domaine)}?candidatId=${encodeURIComponent(candidat._id)}`;
  }
